<template>
  <connection-details name="Zeus" requires="lnd">
    <step-list>
      ...
      <step>
        Tap <span class="font-bold">"Scan lndconnect config"</span>.
      </step>
      <step>
      ...
      <step> Check <span class="font-bold">"Use Tor"</span>. </step>
      <step> Tap <span class="font-bold">"Save Node Config"</span>. </step>
      <step>
        Tap
        <span class="font-bold">"I understand, save my node config"</span>.
      </step>
      <step>
    ...
    <step-list>
      ...
      <step>
        In the <span class="font-bold">"REST Port"</span>, enter
        <input-copy class="my-1" value="8080" auto-width></input-copy>
      </step>
      <step>
        In the <span class="font-bold">"Macaroon (Hex format)"</span>, enter
