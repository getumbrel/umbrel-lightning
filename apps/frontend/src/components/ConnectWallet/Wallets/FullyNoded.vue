<template>
  <connection-details name="Fully Noded (iOS)" requires="bitcoind">
    <step-list>
      ...
      <step>
        Go to <span class="font-bold">Settings > Node Manager > +</span>.
      </step>
      <step>
        ...
        <ul class="connect-wallet-substeps">
          <li class="connect-wallet-substep">
            In the <span class="font-bold">"RPC Username"</span>, enter
            <input-copy
              class="my-1"
          ...
          <li class="connect-wallet-substep">
            In the <span class="font-bold">"RPC Password"</span>, enter
            <input-copy
              class="my-1"
          ...
          <li class="connect-wallet-substep">
            In the <span class="font-bold">"Address"</span>, enter
            <input-copy
              class="my-1"
          ...
          <li class="connect-wallet-substep">
            Tap <span class="font-bold">"Save"</span>.
          </li>
        </ul>
      </step>
      <step>
