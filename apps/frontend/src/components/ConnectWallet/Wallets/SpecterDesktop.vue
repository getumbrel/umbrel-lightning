  ...
  <connection-details name="Specter Desktop" requires="bitcoind">
    ...
    <step-list>
      ...
      <step>
        ...
        <span class="font-bold">"Configure Node"</span>.
      </step>
      <step> Disable <span class="font-bold">"Auto-detect"</span>. </step>
      <step>
        In the <span class="font-bold">"Username"</span>, enter
        <input-copy
          class="my-1"
      ...
      <step>
        In the <span class="font-bold">"Password"</span>, enter
        <input-copy
          class="my-1"
      ...
      <step>
        In the <span class="font-bold">"Host"</span>, enter
        <input-copy
          class="my-1"
      ...
      <step>
        In the <span class="font-bold">"Port"</span>, enter
        <input-copy
          class="my-1"
      ...
      <step>
        Click <span class="font-bold">"Test"</span> to verify if Specter is able
        to connect to your Umbrel.
      </step>
      <step>
        After verifying, click <span class="font-bold">"Save"</span>.
      </step>
      <step>
