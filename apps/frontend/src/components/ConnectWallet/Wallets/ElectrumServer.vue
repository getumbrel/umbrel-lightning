<template>
  <connection-details
    ...
    requires="electrum"
  >
    <div class="d-lg-d-flex align-items-center justify-items-center pb-3">
      <qr-code
      ...
      <div class="w-100 align-self-center ml-lg-3 connect-wallet-steps">
        <div class="connect-wallet-step">
          <label class="mb-1 block"
            ><small class="ml-1 font-bold">Electrum Address</small></label
          >
          <input-copy
            class="my-1"
        ...
        <div class="connect-wallet-step">
          <label class="mb-1 block"
            ><small class="ml-1 font-bold">Electrum Port</small></label
          >
          <input-copy
            class="my-1"
        ...
        <div class="connect-wallet-step">
          <label class="mb-1 block"
            ><small class="ml-1 font-bold">SSL</small></label
          >
